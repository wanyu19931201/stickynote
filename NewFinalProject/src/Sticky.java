...
public class Sticky extends JPanel {
	...
	private class Modify extends JFrame {
		...
		// 表示顏色
		// Color color[] = { Color.WHITE, Color.CYAN, Color.RED, Color.GREEN,
		// Color.BLUE, Color.YELLOW };
		// String colorName[] = { "White", "Cyan", "Red", "Green", "Blue",
		// "Yellow" }; //這是之前的版本
		...
		// 表示大小
		String size[] = { "16", "18", "20", "22", "24", "26", "28" };
		...
		public Modify(int itemNumber) {
			...
			button.addActionListener(new ActionListener() { // 按鈕事件
				...
				public void actionPerformed(ActionEvent e) {
					...
					// fontSelected = new Font("Lucida Grande",
					// font[fontBox.getSelectedIndex()],
					// Integer.valueOf(size[sizeBox.getSelectedIndex()]));
		...
		public void readSticky(int itemNumber) {
			...
			// System.out.println(count);
			/*
			 * setVisible(false); MainIndex x = new MainIndex();
			 * x.setVisible(true);
			 */
		}
	}
