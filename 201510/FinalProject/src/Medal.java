...
public class Medal extends JFrame 
{
	...
	public Medal()
	{
		...
		{
			//ImageIcon iconMedal_1 = new ImageIcon( getClass().getResource( "medal_1.png" ) ); // 解鎖圖示
		...
		{
			//Icon iconMedal_2 = new ImageIcon( getClass().getResource( "medal_2.png" ) );
